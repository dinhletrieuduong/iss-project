...
public abstract class DialogBase extends AnchorPane implements Initializable {
    protected Stage stage;
    private String filename;
    private int width;
    private int height;
    private String title = "Oracle Database Management System v0.9";
    private boolean resizable = true;

    public DialogBase(String filename, int width, int height) {
